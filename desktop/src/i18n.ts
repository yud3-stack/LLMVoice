...
const messages = {
  en: {
    ...
    nowPlaying: "Now playing", preparing: "Preparing render", generating: "Generating voiceover", renderComplete: "Render complete", renderFailed: "Render failed",
    renderActivity: "Render activity", hideRenderActivity: "Hide render activity", showRenderActivity: "Show render activity", waitingForRender: "Waiting for the render worker...", inProgress: "In progress",
     renderedSuccess: "Voiceover rendered successfully.", voiceName: "Voice name", renameProject: "Rename project", deleteProject: "Delete project", feedbackKicker: "FEEDBACK", feedbackTitle: "Share your feedback", feedbackDescription: "Tell us what would make LLMVoice better.", feedbackPlaceholder: "Write your feedback...", feedbackSubmit: "Open feedback form", setupKicker: "FIRST RUN SETUP", setupTitle: "Prepare LLMVoice", setupDescription: "We will check the local components required for voice generation before opening the studio.", setupRuntime: "LLMVoice runtime", setupFfmpeg: "FFmpeg and FFprobe", setupModel: "XTTS voice model", setupInstalled: "Installed", setupMissing: "Missing", setupModelLater: "Can be downloaded later", setupInstall: "Install required components", setupDownloadModel: "Download XTTS model", setupInstalling: "Installing...", setupContinue: "Continue to Studio", setupNote: "Python and FFmpeg must be installed on Windows first. Your audio stays local.",
  },
  tr: {
    ...
    nowPlaying: "Şimdi çalıyor", preparing: "Oluşturma hazırlanıyor", generating: "Seslendirme oluşturuluyor", renderComplete: "Oluşturma tamamlandı", renderFailed: "Oluşturma başarısız",
    renderActivity: "Oluşturma günlüğü", hideRenderActivity: "Oluşturma günlüğünü gizle", showRenderActivity: "Oluşturma günlüğünü göster", waitingForRender: "Ses işçisi bekleniyor...", inProgress: "Sürüyor",
     renderedSuccess: "Seslendirme başarıyla oluşturuldu.", voiceName: "Ses adı", renameProject: "Projeyi yeniden adlandır", deleteProject: "Projeyi sil", feedbackKicker: "GERİ BİLDİRİM", feedbackTitle: "Geri bildiriminizi paylaşın", feedbackDescription: "LLMVoice'u daha iyi hale getirmek için önerinizi yazın.", feedbackPlaceholder: "Geri bildiriminizi yazın...", feedbackSubmit: "Geri bildirim formunu aç", setupKicker: "İLK KURULUM", setupTitle: "LLMVoice'u hazırlayalım", setupDescription: "Stüdyo açılmadan önce ses üretimi için gerekli yerel bileşenleri kontrol edeceğiz.", setupRuntime: "LLMVoice çalışma ortamı", setupFfmpeg: "FFmpeg ve FFprobe", setupModel: "XTTS ses modeli", setupInstalled: "Kurulu", setupMissing: "Eksik", setupModelLater: "Daha sonra indirilebilir", setupInstall: "Gerekli bileşenleri kur", setupDownloadModel: "XTTS modelini indir", setupInstalling: "Kuruluyor...", setupContinue: "Stüdyoya devam et", setupNote: "Python ve FFmpeg önce Windows'a kurulmuş olmalıdır. Ses dosyalarınız yerel kalır.",
  },
} as const;
